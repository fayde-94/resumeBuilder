...
export async function POST(req, res) {
                ...
                ${
                  data.website
                    ...
                    >
                      ...
                      </div><a href="https://${data.website.replace(
                        /^(https?:\/\/)?/,
                        ""
                      )}">${data.website.replace(
                        /^(https?:\/\/)?(www\.)?/,
                        ""
                      )}</a>
                    </div>`
                    ...
                    >
                      ...
                      </div><a href="https://${data.linkedin.replace(
                        /^(https?:\/\/)?/,
                        ""
  ...
  ${data.experience
    ...
    <div key='${i}' class="w-full pb-4 text-lg flex flex-col">
      ...
      <div style='color: ${
        data.accentColor
      };' class="w-full font-medium text-xl pb-4 pt-1 px-1 tracking-basic ">
        ${
          exp.bullet1
            ? `
