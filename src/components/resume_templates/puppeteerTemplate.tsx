...
const PuppeteerTemplate = () => {
  ...
  return (
    <div id="resume-template">
      <div
        id="resume-template"
        className=" w-[1100px] max-w-[1440px] aspect-[1000/1440] shadow-xl bg-white"
      >
        <div className="flex h-full w-full flex-row">
          <div className="flex-col p-6 w-1/2  h-full border-b-neutral-50 space-y-6 bg-sky-800 text-neutral-200">
            ...
            {website ? (
              <div className="w-full ">
                <div className="pb-4 text-white ">
                  ...
                  <div className="w-full border-t-[3px]  rounded-full border-t-neutral-50"></div>
                </div>
            ...
            {technicalSkills !== undefined && technicalSkills.length > 0 ? (
              <div className="w-full">
                ...
                <div className="w-full space-y-3 uppercase font-semibold">
            ...
            <div className="w-full">
              ...
              <div className="w-full space-y-3 uppercase font-semibold">
                <li className=" ml-3 ">CRITICAL THINKING</li>
                <li className=" ml-3 ">PROBLEM SOLVING</li>
                <li className=" ml-3 ">AGILE</li>
                <li className=" ml-3 ">QUICK LEARNING</li>
                <li className=" ml-3 ">PLANNING</li>
              </div>
            </div>
          </div>
          {/* ------------------ RIGHT COLUMN ------------------ */}
          ...
          <div className="flex-col p-6 space-y-6 w-full text-black  h-full">
            ...
            <div className="w-full flex flex-col pt-2 gap-4">
              ...
              <div className="w-full space-y-3 text-xl flex flex-col pb-4">
                ...
                <div className="w-full font-normal space-y-3">
            ...
            <div className="w-full">
              ...
              <div className="w-full space-y-3 text-xl grid grid-cols-2">
                <div className="w-full pb-2 space-y-1">
                  <p className="text-neutral-400 text-[18px] capitalize">
                    January 2011
                  </p>
                  <p className="capitalize">fine arts degree</p>
                  <p className="capitalize text-neutral-600 text-[18px]">
                    acting school
                  </p>
                </div>
